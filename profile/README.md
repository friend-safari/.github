...
There will soon be a list of projects that are outdated and need updating.

I plan to maintain and remove as much AI-use from projects as I can, but I'm only one person.

You can help by:

- Compiling lists of PRs on projects like pokeemerald-expansion, pret's repositories, which contain known AI use.
- Developing alternate implementations to AI PRs where applicable
- Finding the last known AI-free commit on various projects

## Contact

TODO: There will be a Discord server (probably Matrix) eventually.